			...
			<div class="card-body">
                ...
                <div class="container">
					...
					<div class="card-columns">
                        <div class="card">
                          	<a href="/pedidos">
                        		<img class="card-img-top" src="storage\pedidos.png" alt="Card image cap" width="400" height="200">
							</a>  
                    	</div>
						<div class="card">
							<a href="/reservas">
							  <img class="card-img-top" src="storage\reservas.png" alt="Card image cap" width="400" height="200">
						  </a>  
					  </div>
